...
- [x] **Step 1: Write resolver and API tests first**
...
- [x] **Step 4: Run focused API and safety tests**
...
- [x] **Step 1: Write API-boundary tests first**
...
- [x] **Step 3: Bind the contracts without changing the visible workflow**
...
- [x] **Step 4: Run Phase 1A verification**
