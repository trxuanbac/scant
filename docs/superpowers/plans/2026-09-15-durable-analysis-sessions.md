...
- [ ] **Step 4: Verify SQLite model and migration gates**
...
- [ ] **Step 5: Commit schema increment**
...
- [ ] **Step 1: Write failing end-to-end persistence tests**
...
- [ ] **Step 3: Integrate persistence after successful analysis**
...
- [ ] **Step 4: Run workbook and session regression gates**
...
- [ ] **Step 1: Run SQLite and Alembic graph checks**
...
- [ ] **Step 2: Run PostgreSQL 16 migration checks**
...
- [ ] **Step 3: Run all release regressions**
...
- [ ] **Step 5: Final safety checks and commit**
